...
scalacOptions ++= Seq(
  ...
  "-Xlint:-warn-missing-interpolator", // Enable recommended additional warnings but disable missing-interpolator - it results in a false positive for play-swagger
